...
**源码：** reflect/GetClassTest.java

## 1.2 数组的Class对象

**概念：** 判断数组的Class对象是否相同的时候，只比较它们的类型和维度。

**源码：** reflect/ArrayClassTest.java
...
**源码：** reflect/ReflectConstructorTest.reflectConstructor()
...
**源码：** reflect/ReflectConstructorTest.usePublicConstructor()

**源码：** reflect/ReflectConstructorTest.usePrivateConstructor()
...
**源码：** reflect/ReflectFieldTest.reflectField()
...
**源码：** reflect/ReflectFieldTest.usePublicField()

**源码：** reflect/ReflectFieldTest.usePrivateField()
...
**源码：** reflect/ReflectMethodTest.reflectMethods()
...
**源码：** reflect/ReflectMethodTest.usePublicMethod()

**源码：** reflect/ReflectMethodTest.usePrivateMethod()
...
**源码：** reflect/ReflectAnnotationTest.java
...
**源码：** reflect/DynamicOperaTest.java
